                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="comp-edit.php?co_id=<?= $compitem['co_id']; ?>" class="btn btn-success">Edit</a>
                                                        </td>
                                                        <td>
                                                            <form action="code.php" method="POST">
                                                                <input type="hidden" name="comp_delete_id" value="<?= $compitem['co_id']; ?>">
                                                                <button type="submit" name="comp_delete_btn" class="btn btn-danger">Delete</button>
                                                            </form>
                                                        </td>
                                                    </tr>
                                                <?php
