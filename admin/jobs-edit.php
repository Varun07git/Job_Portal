                                        ...
                                        ?>
                                                ...
                                                <div class="modal-body bg-white">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="jname" value="<?= $item['jname']; ?>" class="form-control" required>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="">Description</label>
                                                        <textarea name="jdesc" class="form-control" rows="3" required><?= $item['jdesc']; ?></textarea>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="">email</label>
                                                        <input type="text" name="jemail" value="<?= $item['co_email']; ?>" class="form-control" required>
                                                    </div>
                                                </div>
