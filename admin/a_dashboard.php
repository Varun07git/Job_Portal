...
$sql = "SELECT * FROM tcomp_login";
$result = $conn->query($sql);
$totalcomp = $result->num_rows;


$sql = "SELECT * FROM tuser_login";
$result = $conn->query($sql);
          ...
          <div class="row">
            <div class="col">
              ...
              <div class="small-box bg-info">
                <div class="inner">
                  ...
                  <h4 style="text-align:center";>Total Jobs</h2>
                </div>
                <div class="icon">
            ...
            <div class="col">
              ...
              <div class="small-box bg-success">
                <div class="inner">
                  <h3 style="text-align:center";><?php echo $totalcomp; ?></h3>

                  <h4 style="text-align:center";>Total Companies</h2>
                </div>
                <div class="icon">
                  <i class="ion ion-stats-bars"></i>
                </div>
                <a href="company.php" class="small-box-footer">More info </a>
              </div>
            </div>
            <!-- ./col -->
            <div class="col">
              ...
              <div class="small-box bg-warning">
                <div class="inner">
                  ...
                  <h4 style="text-align:center";>User Registered</h2>
                </div>
                <div class="icon">
                  <i class="ion ion-person-add"></i>
                </div>
                <a href="applicant.php" class="small-box-footer">More info </a>
              </div>
            </div>
            <!-- ./col -->
          </div>
            ...
            <div class="row">
                <div class="col-sm-4 col-md-4">
                    <div class="thumbnail candidate-img">
                        <img src="images/browse.jpg" alt="Browse Jobs">
                        <div class="caption">
                ...
                <div class="col-sm-4 col-md-4">
                    <div class="thumbnail candidate-img">
                        <img src="images/interviewed.jpeg" alt="Apply & Get Interviewed">
                        <div class="caption">
                ...
                <div class="col-sm-4 col-md-4">
                    <div class="thumbnail candidate-img">
                        <img src="images/career.jpg" alt="Start A Career">
                        <div class="caption">
