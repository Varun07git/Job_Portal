                    ...
                    <form action="code.php" method="POST">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="jdesc" class="form-control" rows="3" required></textarea>
                            </div>
                            <div class="form-group">
                                <label for="">Companies email</label>
                                <input type="text" name="jemail" class="form-control">
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                            <button type="submit" name="job_save" class="btn btn-primary">Save</button>
                        </div>
                    </form>
                                    ...
                                    <table class="table table-bordered bg-white">
                                        ...
                                        <tbody>
                                            ...
                                            if (mysqli_num_rows($query_run) > 0) {
                                                foreach ($query_run as $jobitem) {
                                            ?>
                                                    <tr>
                                                        <td><?php echo $jobitem['jid']; ?></td>
                                                        <td><?php echo $jobitem['jname']; ?></td>
                                                        <td><?php echo $jobitem['jdesc']; ?></td>
                                                        <td><?php echo $jobitem['co_email']; ?></td>
                                                        <td>
                                                            <a href="jobs-edit.php?jid=<?= $jobitem['jid']; ?>" class="btn btn-success">Edit</a>
                                                        </td>
                                                        <td>
                                                            <form action="code.php" method="POST">
                                                                <input type="hidden" name="job_delete_id" value="<?= $jobitem['jid']; ?>">
