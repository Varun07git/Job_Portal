                            ...
                            <div class="card">
                                ...
                                <div class="card-body bg-white">
                                    <table class="table table-bordered bg-white">
                                        ...
                                        <tbody>
                                            <?php
                                            $query = "SELECT * FROM `applied jobs` WHERE co_email='$email'";
                                            ...
                                            ?>
                                                    <tr>
                                                        <td><?php echo $jobitem['aj_id']; ?></td>
                                                        <td><?php echo $jobitem['aj_title']; ?></td>
                                                        <td><?php echo $jobitem['aj_desc']; ?></td>
                                                        <td><?php echo $jobitem['ap_email']; ?></td>
                                                        <td>
                                                            <form action="code.php" method="POST">
                                                                <input type="hidden" name="job_delete_id" value="<?= $jobitem['aj_id']; ?>">
